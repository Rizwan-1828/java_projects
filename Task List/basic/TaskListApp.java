...
public class TaskListApp {
    public static void main(String[] args) {
        ...
        while (true) {
            displayMenu();
            // We read the choice, but we need to handle the newline right here
    ...
    private static String getTaskName(Scanner scanner) {
        ...
        // FIX: Use nextLine() instead of next() to allow spaces in task names
    ...
    private static int getUserInput(Scanner scanner, String prompt) {
        ...
        scanner.nextLine(); // FIX: Consume the leftover newline character here too
        return input;
    }
}
